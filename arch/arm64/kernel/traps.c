...
void do_el1_fpac(struct pt_regs *regs, unsigned int esr)
{
	/*
...
void do_el0_cp15(unsigned int esr, struct pt_regs *regs)
{
...
void do_el0_sys(unsigned int esr, struct pt_regs *regs)
{
